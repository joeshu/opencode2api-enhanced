export function getUserFacingHint(errorLike) {
    ...
    if (type === 'tool_permission_required') {
        return {
            retryable: true,
            hint: 'A tool requires permission or confirmation before it can continue. Retry in a mode that supports tool confirmation, or ask for a non-tool answer.'
        };
    }
